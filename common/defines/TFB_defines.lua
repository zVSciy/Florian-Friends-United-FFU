...
NDefines.NProduction.BASE_FACTORY_START_EFFICIENCY_FACTOR = 15	-- FFU: 15%  Base start efficiency for factories expressed in %.
NDefines.NProduction.BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 40 --FFU: 50%  Base CAP
