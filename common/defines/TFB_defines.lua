...
NDefines.NProduction.BASE_FACTORY_START_EFFICIENCY_FACTOR = 5	-- FFU: 15%  Base start efficiency for factories expressed in %.
NDefines.NProduction.BASE_FACTORY_MAX_EFFICIENCY_FACTOR = 30 --FFU: 50%  Base CAP
