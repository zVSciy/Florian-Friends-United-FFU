...
NDefines.NAir.NAVAL_STRIKE_CARRIER_MULTIPLIER = 1.25              -- damage bonus when planes are in naval combat where their carrier is present (and can thus sortie faster and more effectively)
