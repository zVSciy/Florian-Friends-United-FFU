...
NDefines.NMilitary.EQUIPMENT_COMBAT_LOSS_FACTOR	= 0.6 				-- Vanilla: 0.7, % of equipment lost to strength ratio in combat, so some % is returned if below 1
...
NDefines.NMilitary.PLANNING_MAX = 0.2 -- 0.2 in tfb                           	-- can get more from techs
